...
def connect_node():
    ...
    for node in nodes:
        ...
        response = {"message" : "All the nodes are connected. The hadcoin blockchain contains following nodes:",
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {"message" : "The chain is replaced by the longest chain.",
                    "new_chian" : blockchain.chain}
    else:
        response = {"message" : "All good chain is already the longest one.",
